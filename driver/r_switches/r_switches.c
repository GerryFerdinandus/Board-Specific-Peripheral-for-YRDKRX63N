...
//https://gcc.gnu.org/onlinedocs/gcc/RX-Function-Attributes.html#RX-Function-Attributes

//#pragma is for renesas RX compiler only
//#pragma interrupt (sw1_isr (vect=_VECT(X_IRQ(SW1_IRQ_NUMBER))))

//GCC
//void __attribute__ ((interrupt (  _VECT(X_IRQ(SW1_IRQ_NUMBER))  ))) static sw1_isr ();

void __attribute__ ((interrupt (  hghg  ))) static sw1_isr ();

/* Function prototype. */
static void sw1_isr (void) __attribute__((interrupt));
